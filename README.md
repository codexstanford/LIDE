...
* [`src/lide/`](src/lide/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/lide/core.cljs): contains the SPA entry point, `init`
* [`test/lide/`](test/lide/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `lide` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/lide/config.cljs) defaults to `true` in
